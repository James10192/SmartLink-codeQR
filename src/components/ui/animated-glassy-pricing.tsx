    ...
    <div className="flex-1 min-w-[280px] max-w-xs">
      <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-white/10 p-2 md:rounded-[1.5rem] md:p-3">
        <GlowingEffect
          ...
          borderWidth={3}
        />
        <div className={`relative flex h-full flex-col overflow-hidden rounded-xl border-[0.75px] bg-black/40 backdrop-blur-sm p-7 shadow-sm ${isPopular ? 'border-cyan-400/30' : 'border-white/10'}`}>
          {isPopular && (
            <div className="absolute -top-2 right-4 px-3 py-1 text-[12px] font-semibold rounded-full bg-cyan-400 text-black">
              Populaire
            </div>
          )}
          <div className="mb-3">
          ...
          <div className="my-6 flex items-baseline gap-2">
            ...
            <span className="text-[14px] text-white/70 font-sans">/mois</span>
          </div>
